...
public class ApiException extends RuntimeException {
    ...
    public ApiException(String errorCode, HttpStatus status, String defaultMessage, Map<String, Object> parameters) {
    ...
    private static String parametersToString(Map<String, Object> parameters) {
